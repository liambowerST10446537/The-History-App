...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fact.setOnClickListener {
            ...
            if (value in 10..19 )
                show.text = "Marlene Lehnberg died at the age of 18."
            else if(value in 20..29) {
            ...
            } else if (value in 70..79) {
                show.text =
                    "Nelson Mandela was released from prison in his 70's after being incarcerated for 27 years."
            } else if (value in 80..89){
                show.text = "Robert Dinero is in his 80's."
            } else if (value in 90..100){
                show.text = "Nelson Mandela died at the age of 95."
            }
